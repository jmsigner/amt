...
x1 <- track(x = 1:10, y = 1:10, z = 1:10)
x2 <- track(x = 1:10, y = 1:10, t = 3, z = 1:10)
x3 <- track(id = 34, x = 1:10, burst = 3, y = 1:10, z = 1:10, t = 3)

class(filter(x3, y_ > 3))
class(filter(x2, y_ > 3))
class(filter(x1, y_ > 3))
